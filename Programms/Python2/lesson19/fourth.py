        ...
        for y in range(self.height):
            for x in range(self.width):
                if self.board[y][x] == 0:
                    ...
                    pygame.draw.rect(screen, (0, 0, 255), (x * self.cell_size + self.left, y * self.cell_size + self.top,
                                                           self.cell_size, self.cell_size))
                else:
                    pygame.draw.rect(screen, (255, 0, 0), (x * self.cell_size + self.left, y * self.cell_size + self.top,
                                                               self.cell_size, self.cell_size))
