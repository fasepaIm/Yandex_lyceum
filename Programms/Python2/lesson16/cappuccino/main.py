...
class MyWidget(QMainWindow):
    def __init__(self):
        ...
        self.tableWidget.itemDoubleClicked.connect(self.add_edit_table)
        self.open_add_window.clicked.connect(self.add_edit_table)
        self.write_to_table()

    def add_edit_table(self):
        self.window = AddEditWindow()
        self.window.show()
